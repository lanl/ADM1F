...
The modified version of the ADM1F includes SRT and other modifications described in the [user guide](https://github.com/Elchin/ADM1F_docs/blob/docs/sphinx/build/latex/adm1f.pdf) and [documentation](https://elchin.github.io/ADM1F_docs/).
